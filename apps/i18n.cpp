...
const char * messages[244][5] {
  ...
  {"Kaleculation", "Calculs", "Calculos", "Berechnung", "Calculo"},
  ...
  /* 1.Kaleculation */
  {"Kaleculation", "Calculs", "Calculo", "Berechnung", "Calculo"},
  {"KALECULATION", "CALCULS", "CALCULO", "BERECHNUNG", "CALCULO"},
  ...
  {"Avogadro's Number", "Avogadro's Number", "Avogadro's Number", "Avogadro's Number", "Avogadro's Number"},
  {"Element Molar Masses", "Element Molar Masses", "Element Molar Masses", "Element Molar Masses", "Element Molar Masses"},
  {"Data from git.io/v5i9S", "Data from git.io/v5i9S", "Data from git.io/v5i9S", "Data from git.io/v5i9S", "Data from git.io/v5i9S"},
};
...
const char * universalMessages[478] {
  "",
  "Python",
  "PYTHON (BETA)",
  "alpha",
